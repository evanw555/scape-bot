...
describe('Util Tests', () => {
    ...
    it('determines if an update diff passes an interval milestone', () => {
        ...
        expect(diffPassesMilestone(1, 100, 0), 'Update 1-to-100 does NOT pass 0-interval milestone').is.false;
        ...
        expect(diffPassesMilestone(1, 1, 1), 'Update 1-to-1 does NOT pass 1-interval milestone').is.false;
        // Negatives
        expect(diffPassesMilestone(11, 10, 1), 'Update 11-to-10 passes 1-interval milestone').is.true;
        ...
        // Negatives
        expect(diffPassesMilestone(10, 9, 2), 'Update 10-to-9 passes 2-interval milestone').is.true;
        expect(diffPassesMilestone(10, 8, 2), 'Update 10-to-8 passes 2-interval milestone').is.true;
        expect(diffPassesMilestone(9, 8, 2), 'Update 9-to-8 does NOT pass 2-interval milestone').is.false;
        ...
        expect(diffPassesMilestone(10, 8, 3), 'Update 10-to-8 passes 3-interval milestone').is.true;
        expect(diffPassesMilestone(10, 7, 3), 'Update 10-to-7 passes 3-interval milestone').is.true;
        ...
        // Negatives
        expect(diffPassesMilestone(10, 9, 5), 'Update 10-to-9 passes 5-interval milestone').is.true;
        expect(diffPassesMilestone(10, 5, 5), 'Update 10-to-5 passes 5-interval milestone').is.true;
        expect(diffPassesMilestone(9, 5, 5), 'Update 9-to-5 does NOT pass 5-interval milestone').is.false;
        ...
        // Negatives
        expect(diffPassesMilestone(20, 19, 10), 'Update 20-to-19 passes 10-interval milestone').is.true;
        expect(diffPassesMilestone(20, 10, 10), 'Update 20-to-10 passes 10-interval milestone').is.true;
        expect(diffPassesMilestone(19, 10, 10), 'Update 19-to-10 does NOT pass 10-interval milestone').is.false;
        ...
        expect(diffPassesMilestone(50, 1, 13), 'Update 50-to-1 passes 13-interval milestone').is.true;
        expect(diffPassesMilestone(25, 13, 13), 'Update 25-to-13 does NOT pass 13-interval milestone').is.false;
    });
